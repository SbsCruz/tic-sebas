...
# Ejemplo de uso:
input_file = "forms"
ruta_archivo_tex = f'docs-examples/{input_file}.tex'  # Ruta relativa al archivo .tex
ruta_archivo_txt = f'api-ollama/extracted/{input_file}.txt'  # Ruta relativa para el archivo .txt a generar
